...
{
    const char* pszTimestamp = "Guardian 08/SEP/2018 Barack Obama in California to rally Democrats for midterms House push";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xd744af2ad8a3c2845dcf0c1d5ddf5f0c638b53e3b173c93d5ff7a0e51a724c24"); //1441280
        ...
        genesis = CreateGenesisBlock(1536413979, 113770, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd744af2ad8a3c2845dcf0c1d5ddf5f0c638b53e3b173c93d5ff7a0e51a724c24"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5c61c5df6d66b99a19325f922610dac0f4d01ed292fe2187861be094d51108"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0xd744af2ad8a3c2845dcf0c1d5ddf5f0c638b53e3b173c93d5ff7a0e51a724c24")},
        ...
        chainTxData = ChainTxData{
            ...
            1536413979, // * UNIX timestamp of last known number of transactions
